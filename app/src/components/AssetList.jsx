...
export default function AssetList({ onSelect, selected }) {
  ...
  return (
    <div
      className={`overflow-x-auto transition-all duration-300 ease-in-out ${selected ? "flex-shrink-0" : "w-full"}`}
    >
      {/* header */}
      <div className="grid grid-cols-5 rounded border border-gray-200 bg-gray-50 font-semibold text-gray-700 p-3">
        <div> </div>
        <div>Type</div>
        <div>Location</div>
        <div>Status</div>
